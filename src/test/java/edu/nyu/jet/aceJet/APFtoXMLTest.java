...
public class APFtoXMLTest {
	...
	static final String propertyFile = "props/ace2005Chunker.jet";
	...
	public void testAPFtoXML1 () throws Exception {
		...
		if (null == Ace.processDocument (doc, "TD", "TD", "")) {
			System.out.println("aceDoc is null!");
			//		} else {
			//			System.out.println(Ace.processDocument (doc, "TD", "TD", null));
		}
