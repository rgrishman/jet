...
public class AceDocument {
	...
	public edu.nyu.jet.tipster.Document JetDocument() {
		if (fileTextWithXML == null) {
			fileTextWithXML = new StringBuffer();
			fileTextWithXML.append(fileText);
		}
		edu.nyu.jet.tipster.Document doc = new edu.nyu.jet.tipster.Document (fileTextWithXML.toString());
	...
	*/
	...
	public void write (PrintWriter w, edu.nyu.jet.tipster.Document doc) {
